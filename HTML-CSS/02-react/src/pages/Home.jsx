...
export function HomePage (){
    ...
    return(
         <main>
                <section>
                    <img src="./background.webp" width="200" height="150"/>

                    <h1>Encuentra el trabajo de tus sueños</h1>

                    <p>Únete a la comunidad más grandre de desarrolladores y encuentra tu próxima oportunidad.</p>
                    ...
                    <form role="search" onSubmit={handleSearch}>
                        <div>
                            ...
                            <input type="text" placeholder="Buscar ofertas por título, habilidad o empresa"/>
                ...
                <section>
                    ...
                    <footer>
                        <article>
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="1"  strokeLinecap="round"  strokeLinejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-briefcase-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 9a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-9z" /><path d="M8 7v-2a2 2 0 0 1 2 -2h4a2 2 0 0 1 2 2v2" /></svg>
                        ...
                        <article>
                            ...
                            <p>Conecta con empresas que están contartando por tus habilidades.</p>
                        </article>
